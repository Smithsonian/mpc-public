...
This guide covers observing minor planets, comets and natural satellites, and reporting observations to the Minor Planet Center.
...
- [Validate ADES Observation Files](../../tutorials/notebooks/mpc_tutorial_ades_validation.ipynb)
- [Convert 80-Column Observations to ADES](../../tutorials/notebooks/mpc_tutorial_ades_conversion.ipynb)
- [Submit Observations](../../tutorials/notebooks/mpc_tutorial_api_submission_submission.ipynb)
- [Check Submission Status](../../tutorials/notebooks/mpc_tutorial_api_submission_status.ipynb)
