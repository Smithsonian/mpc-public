...
| Minor Planet (Forced Orbit) | 8 | Object whose orbit was manually determined or comes from legacy sources. |
| Minor Planet (No Orbit) | 9 | Object with no meaningful orbit information available. |
...
| Comet (Forced Orbit) | 14 | Comet whose orbit was manually determined or comes from legacy sources. |
